    ...
    public class LoginValidateAttribute : System.Web.Mvc.AuthorizeAttribute
    {
        ...
        public override void OnAuthorization(System.Web.Mvc.AuthorizationContext filterContext)
        {
            ...
            if (filterContext.RouteData.DataTokens.Keys.Contains("area")//当前请求匹配的 路由对象中 是否 有 area区域
                && filterContext.RouteData.DataTokens["area"].ToString().ToLower() == "haytnadmin")//监测区域名 是否为 admin
            {
                    ...
                    !filterContext.ActionDescriptor.ControllerDescriptor.IsDefined(typeof(Common.Attributes.SkipAttribute), false))
                {
                    ...
                    {
                        filterContext.Result = OperateContext.Current.Redirect("/HayTnAdmin/Admin/AdminLogin", filterContext.ActionDescriptor);
                    }
                    #endregion
                    ...
                    else
                    {
                        ...
                        {
                            filterContext.Result = OperateContext.Current.Redirect("/HayTnAdmin/Admin/AdminLogin?msg=noPermission", filterContext.ActionDescriptor);
                        }
                    }
                    #endregion
                }
